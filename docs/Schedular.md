...
As well as performance, the Schedular can take in any kind of object Tome is able to take in. This allows you to schedule removal of threads, classes, functions and more.